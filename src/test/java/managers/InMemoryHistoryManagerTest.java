...
class InMemoryHistoryManagerTest {
    ...
    void getHistory(){
            ...
            System.out.println(inMemoryTaskManager.inMemoryHistoryManager.history);
            ...
            System.out.println(inMemoryTaskManager.inMemoryHistoryManager.getHistory()); // должны остаться только task
